    ...
    <nav class="navbar navbar-expand-lg navbar-light position-absolute w-100 p-lg-2 p-0" style="z-index: 1000">
        ...
        <div class="collapse navbar-collapse bp" id="navbarNav">
            <ul id="navbarNavUl" class="navbar-nav d-flex justify-content-between text-center bp">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php if($nav == 0) { echo "#about"; } else { echo base_url()."home#about"; }?>">About</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php if($nav == 0) { echo "#fakultas"; } else { echo base_url()."home#fakultas"; }?>">fakultas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php if($nav == 0) { echo "#prestasi"; } else { echo base_url()."home#prestasi"; }?>">prestasi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php if($nav == 0) { echo "#fasilitas"; } else { echo base_url()."home#fasilitas"; }?>">fasilitas</a>
                </li>
