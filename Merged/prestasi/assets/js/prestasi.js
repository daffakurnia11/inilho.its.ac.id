...
function main_prestasi() {
	if (window.innerWidth <= breakpoints["lg"]) {
		if (prestasiHeader) {
			prestasiHeader.src = "assets/images/prestasi-header-sm.png";
			meetBg.src = "assets/images/meet-sm.png";
		}
	} else {
		if (prestasiHeader) {
			prestasiHeader.src = "assets/images/prestasi-header.png";
			meetBg.src = "assets/images/meet.png";
		}
	}
}
